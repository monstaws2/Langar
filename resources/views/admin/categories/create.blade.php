...
@section('content')
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" class="bg-white rounded-lg shadow overflow-hidden">
            @csrf
            <div class="px-6 py-6">
                <h2 class="text-xl font-medium text-brand-charcoal mb-6">افزودن دسته‌بندی جدید</h2>
