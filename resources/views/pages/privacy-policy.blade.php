...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-8 sm:p-12">
        ...
        <div class="prose prose-lg max-w-none text-gray-600 leading-relaxed space-y-6">
            <p>
                فروشگاه خانه‌ی موتور متعهد به حفظ حریم خصوصی کاربران است. این سیاست حریم خصوصی توضیح می‌دهد که ما چه اطلاعاتی را جمع‌آوری می‌کنیم، چگونه از آن‌ها استفاده می‌کنیم و چگونه از آن‌ها محافظت می‌کنیم.
            </p>
            ...
            <p>
                سایت خانه‌ی موتور از کوکی‌ها برای ذخیره سبد خرید، بهبود تجربه کاربری و تحلیل ترافیک استفاده می‌کند. با ادامه استفاده از سایت، شما با استفاده از کوکی‌ها موافقت می‌کنید.
            </p>
            ...
            <p>
                اگر سوالی درباره حریم خصوصی دارید، از طریق صفحه <a href="{{ route('contact.index') }}" class="text-brand-red hover:underline">تماس با ما</a> یا ایمیل info@khanemotor.ir با ما در ارتباط باشید.
            </p>
        </div>
    </div>
</div>
