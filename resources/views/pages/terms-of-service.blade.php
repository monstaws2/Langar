...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-8 sm:p-12">
        ...
        <div class="prose prose-lg max-w-none text-gray-600 leading-relaxed space-y-6">
            <p>
                با دسترسی و استفاده از فروشگاه اینترنتی لنگر موتور، شما موافقت خود را با این شرایط و مقررات اعلام می‌کنید. لطفاً قبل از استفاده از خدمات سایت، این صفحه را به دقت مطالعه فرمایید.
            </p>
            ...
            <ul class="space-y-2 mr-6 list-disc">
                <li><strong>«لنگر موتور»</strong> یا <strong>«ما»</strong>: به فروشگاه اینترنتی لنگر موتور و تیم مدیریتی آن اشاره دارد.</li>
            ...
            <p>
                تمامی محصولات لنگر موتور دارای ضمانت اصالت کالا هستند. در صورت عدم رضایت، امکان بازگشت کالا طبق شرایط صفحه <a href="{{ route('shipping-returns') }}" class="text-brand-red hover:underline">شرایط ارسال و بازگشت</a> وجود دارد.
            </p>
            ...
            <p>
                لنگر موتور تلاش می‌کند اطلاعات دقیق و به‌روز در سایت ارائه دهد، اما مسئولیت استفاده صحیح از محصولات بر عهده خریدار است. ما در قبال خسارات ناشی از استفاده نادرست از محصولات مسئولیتی نداریم.
            </p>
